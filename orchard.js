...
averageDailyAcres = 0
for (i = 0; i < fujiAcres.length; i++) {
averageDailyAcres += (fujiAcres[i] + galaAcres[i] + pinkAcres[i]) / fujiAcres.length
}
...
for (i = 0; i < fujiAcres.length; i++) {
  fujiTons[i] = fujiAcresCopy[i] * 6.5
  galaTons[i] = galaAcresCopy[i] * 6.5
  pinkTons[i] = pinkAcresCopy[i] * 6.5
}
